...
const (
	...
	// FlagRaw outputs the raw chain response instead of user-friendly formatting.
	FlagRaw   = "raw"
	FlagSplit = "split"
...
func AddQueryFlagsToCmd(cmd *cobra.Command) {
	...
	cmd.Flags().Bool(FlagRaw, false, "Output raw chain response instead of user-friendly formatting")
}
...
func AddTxFlagsToCmd(cmd *cobra.Command) {
	...
	f.Bool(FlagRaw, false, "Output raw chain response instead of user-friendly formatting")
