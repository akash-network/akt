...
func MsgVote(cctx client.Context, args ...string) (testutil.BufferWriter, error) {
	return clitestutil.ExecTestCLICmd(cctx, govcli.NewCmdWeightedVote(), args)
}

// MsgDeposit deposits on a proposal
func MsgDeposit(cctx client.Context, args ...string) (testutil.BufferWriter, error) {
	return clitestutil.ExecTestCLICmd(cctx, govcli.NewCmdDeposit(), args)
}
