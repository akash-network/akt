...
type StartCmdOptions struct {
	...
	PostSetup func(svrCtx *sdksrv.Context, cctx client.Context, ctx context.Context, g *errgroup.Group) error
	// PostSetupStandalone can be used to setup extra services under the same cancellable context,
	PostSetupStandalone func(svrCtx *sdksrv.Context, cctx client.Context, ctx context.Context, g *errgroup.Group) error
	// AddFlags add custom flags to start cmd
	AddFlags func(cmd *cobra.Command)
	// StartCommandHandler can be used to customize the start command handler
	StartCommandHandler func(svrCtx *sdksrv.Context, cctx client.Context, appCreator types.AppCreator, inProcessConsensus bool, opts StartCmdOptions) error
}
...
func startStandAlone(sctx *sdksrv.Context, svrCfg serverconfig.Config, cctx client.Context, app types.Application, metrics *telemetry.Metrics, opts StartCmdOptions) error {
	...
	if svrCfg.API.Enable || svrCfg.GRPC.Enable {
		...
		// do not use := to avoid shadowing cctx
		cctx = cctx.WithClient(rpcclient)

		// use the provided cctx to register the services
