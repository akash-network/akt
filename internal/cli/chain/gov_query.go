...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return pretty.PrintQueryResultAny(cmd, cl.ClientContext(), res.Proposal)
		},
	}
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return pretty.PrintQueryResultAny(cmd, cl.ClientContext(), res.Vote)
		},
	}
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return pretty.PrintQueryResultAny(cmd, cl.ClientContext(), res.Deposit)
		},
	}
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return pretty.PrintQueryResultAny(cmd, cl.ClientContext(), res.Tally)
		},
	}
...
`,
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			return pretty.PrintQueryResultAny(cmd, cctx, prop)
		},
	}
