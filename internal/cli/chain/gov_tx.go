...
func GetTxGovDraftProposalCmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, _ []string) error {
			...
			if proposal.MsgType != "" {
				proposal.Msg, err = sdk.GetMsgFromTypeURL(cctx.Codec, proposal.MsgType)
				if err != nil {
					// should never happen
					panic(err)
				}
			...
			result, metadata, err := proposal.Prompt(cctx.Codec, skipMetadataPrompt)
			if err != nil {
				return err
			}
...
func GetTxGovWasmProposalStoreCodeCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		Args:  cobra.ExactArgs(1),
		RunE: func(cmd *cobra.Command, args []string) error {
			cctx, proposalTitle, summary, deposit, expedite, err := getProposalInfo(cmd)
			if err != nil {
				return err
			}
			...
			proposalMsg, err := v1.NewMsgSubmitProposal([]sdk.Msg{&storeCodeMsg}, deposit, cctx.GetFromAddress().String(), "", proposalTitle, summary, expedite)
			if err != nil {
				return err
			}

			return tx.GenerateOrBroadcastTxCLI(cctx, cmd.Flags(), proposalMsg)
		},
		SilenceUsage: true,
	}
...
func GetTxGovWasmProposalInstantiateContractCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			instantiateMsg, err := ParseWasmInstantiateArgs(args[0], args[1], cctx.Keyring, authority, cmd.Flags())
			if err != nil {
				return err
			}

			proposalMsg, err := v1.NewMsgSubmitProposal([]sdk.Msg{instantiateMsg}, deposit, cctx.GetFromAddress().String(), "", proposalTitle, summary, expedite)
			if err != nil {
				return err
			}
...
func GetTxGovWasmProposalInstantiateContract2Cmd() *cobra.Command {
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			data, err := ParseWasmInstantiateArgs(args[0], args[1], cctx.Keyring, authority, cmd.Flags())
			if err != nil {
				return err
			}
	...
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			if adminStr != "" {
				...
				if err != nil {
					info, err := cctx.Keyring.Key(adminStr)
					if err != nil {
						return fmt.Errorf("admin %s", err)
					}
			...
			proposalMsg, err := v1.NewMsgSubmitProposal([]sdk.Msg{&storeAndInstantiateMsg}, deposit, cctx.GetFromAddress().String(), "", proposalTitle, summary, expedite)
			if err != nil {
				return err
			}
...
func GetTxGovWasmProposalMigrateContractCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			proposalMsg, err := v1.NewMsgSubmitProposal([]sdk.Msg{&migrateMsg}, deposit, cctx.GetFromAddress().String(), "", proposalTitle, summary, expedite)
			if err != nil {
				return err
			}
...
func GetTxGovWasmProposalExecuteContractCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			proposalMsg, err := v1.NewMsgSubmitProposal([]sdk.Msg{&msg}, deposit, cctx.GetFromAddress().String(), "", proposalTitle, summary, expedite)
			if err != nil {
				return err
			}
...
func GetTxGovWasmProposalUpdateContractAdminCmd() *cobra.Command {
	cmd := &cobra.Command{
		...
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			proposalMsg, err := v1.NewMsgSubmitProposal([]sdk.Msg{&upgradeAdminMsg}, deposit, cctx.GetFromAddress().String(), "", proposalTitle, summary, expedite)
			if err != nil {
				return err
			}
...
`, version.AppName, bech32Prefix, bech32Prefix)),
		RunE: func(cmd *cobra.Command, args []string) error {
			...
			proposalMsg, err := v1.NewMsgSubmitProposal(msgs, deposit, cctx.GetFromAddress().String(), "", proposalTitle, summary, expedite)
			if err != nil {
				return err
			}
...
func getProposalInfo(cmd *cobra.Command) (client.Context, string, string, sdk.Coins, bool, error) {
	...
	return cctx, proposalTitle, summary, deposit, expedite, nil
}
