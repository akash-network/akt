...
func SignTx(txFactory tx.Factory, cctx client.Context, name string, txBuilder client.TxBuilder, offline, overwriteSig bool) error {
...
func populateAccountFromState(
	txBldr tx.Factory, cctx client.Context, addr sdk.AccAddress,
) (tx.Factory, error) {
	num, seq, err := cctx.AccountRetriever.GetAccountNumberSequence(cctx, addr)
	if err != nil {
		return txBldr, err
	}
